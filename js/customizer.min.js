(() => {
  const e = (e) => localStorage.getItem(e),
    ...
    a = `\n    :root {\n      ${
      ...
      `--${r}btn-hover-bg: ${e("theme-info-btn-hover-active-border-bg-color")};`
    }\n      ${
      e("theme-info-btn-hover-active-border-bg-color") &&
      `--${r}btn-hover-border-color: ${e(
      ...
      `--${r}accordion-btn-active-icon: ${e("theme-accordion-btn-active-icon")}`
    }\n    }\n  `;
  let i = a;
  ...
  for (let n = 0; n < p.length; n++)
    (p[n].value = e("theme-" + p[n].id + "multiplier") || p[n].value),
      p[n].addEventListener("input", (e) => {
        ...
        t("theme-" + e.target.id, "calc(var(--ar-border-radius) * " + n + ")"),
